    ...
    setTimeout(() => {
        ...
        updateForm.addEventListener("click", (e) => {
            ...
            if (oldPwd === model.password) {
                update(`http://localhost:5000/api/users`, { "email": email, "username": username, "country": country, "password": password }, () => updateView({ "Email": email, "Username": username, "Country": country, "Password": password }))
            };
        })
    }, 500);
}